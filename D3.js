...
for (let i = 0; i < starWarsCharacters.length; i++) {
  let EachNames = starWarsCharacters[i].name;
  charactersNames.push(EachNames);
}
...
/* --EXTRA-- ESERCIZIO 9
  ...
  rimuovi dall'array "charactersNames" le stringhe corrispondenti a personaggi 
  con lo stesso nome.
  Una volta fatto crea un console.log per controllare la proprietà length 
  di "charactersNames" prima e dopo l'operazione.
*/
console.log("Characters Names length", charactersNames.length);
